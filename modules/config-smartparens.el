...
(cl-macrolet
  ...
  (generate-calls sp-define-bindings
    (
      ("gs" #'sp-sexp-ops)
      ("gsf" #'evil-smart-forward-sexp)
      ("gsb" #'evil-smart-backward-sexp)
      ("gsd" #'evil-smart-down-sexp)
      ("gsD" #'evil-smart-backward-down-sexp)
      ("gsu" #'evil-smart-up-sexp)
      ("gsU" #'evil-smart-backward-up-sexp)
      ("gsn" #'evil-smart-next-sexp)
      ("gsp" #'evil-smart-previous-exp)
      ("gsk" #'sp-kill-sexp)
