...
(cl-macrolet
  ...
  (generate-calls sp-define-bindings
    (
      ("g s" #'sp-sexp-ops)
      ("g s f" #'evil-smart-forward-sexp)
      ("g s b" #'evil-smart-backward-sexp)
      ("g s d" #'evil-smart-down-sexp)
      ("g s D" #'evil-smart-backward-down-sexp)
      ("g s u" #'evil-smart-up-sexp)
      ("g s U" #'evil-smart-backward-up-sexp)
      ("g s n" #'evil-smart-next-sexp)
      ("g s p" #'evil-smart-previous-sexp)
      ("g s k" #'sp-kill-sexp)
      ("g s K" #'sp-backward-kill-sexp)
      ("g s w" #'sp-unwrap-sexp)
      ("g s W" #'sp-backward-unwrap-sexp)
      ("g s s" #'sp-split-sexp)
      ("g s j" #'sp-join-sexp)
      ("g s a" #'sp-absorb-sexp)
      ("g s e" #'sp-emit-sexp)
      ("g s ." #'sp-smart-forward-barf-sexp)
      ("g s <" #'sp-smart-backward-slurp-sexp)
      ("g s >" #'sp-smart-backward-barf-sexp))))
