...
(define-key evil-normal-state-map (kbd "g s f") 'evil-forward-sexp)
(define-key evil-normal-state-map (kbd "g s b") 'evil-backward-sexp)
(define-key evil-normal-state-map (kbd "g s d") 'evil-down-sexp)
(define-key evil-normal-state-map (kbd "g s D") 'evil-backward-down-sexp)
(define-key evil-normal-state-map (kbd "g s e") 'evil-up-sexp)
