...
(let ((nmap evil-normal-state-map))
  ...
  (define-key nmap (kbd "g s d") 'evil-down-sexp)
  (define-key nmap (kbd "g s D") 'evil-backward-down-sexp)
  (define-key nmap (kbd "g s e") 'evil-up-sexp)
  (define-key nmap (kbd "g s U") 'evil-backward-up-sexp)
  (define-key nmap (kbd "g s n") 'evil-next-sexp)
  (define-key nmap (kbd "g s p") 'evil-previous-sexp)
